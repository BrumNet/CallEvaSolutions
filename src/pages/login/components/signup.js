...
export function SignUp(props) {
  ...
  return (
    <div id="signuppage">
      <center>SignUp As {privilege}</center>
      <br />
      <center>
        <button
          onClick={() => setPrivilege("Customer")}
          className={privilege === "Customer" ? "logactive" : ""}
        >
          Customer
        </button>
        <button
          onClick={() => setPrivilege("Provider")}
          className={privilege === "Provider" ? "logactive" : ""}
        >
          Provider
        </button>
      </center>
      ...
      <center>
        ...
        <input ref={contactRef} type="tel" placeholder="Contact Number" />
        <br />
      </center>
      <center>
        <input ref={pwdRef} type="password" placeholder="Password" />
        <input ref={cpwdRef} type="password" placeholder="Confirm Password" />
        <br />
      </center>

      {error === "pwd" ? <p>Password doesn{`&apos`}t match</p> : <></>}
      ...
      <div>
        <span>
          <small>
            By signing up, you agree to CallEva Terms and Conditions
          </small>
        </span>
      </div>
      <button onClick={() => signUpRes()}>SignUp</button>
      <br />
      <br />
    </div>
  );
