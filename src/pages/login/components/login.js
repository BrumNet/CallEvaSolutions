...
export function Login() {
  ...
  const result = async () => {
    ...
    if (user?.privilege) {
      Array.from(Object.keys(sessionData)).forEach(
        (x) => delete sessionData[x],
      );
  ...
  return !forgotEmail ? (
    <div id="loginpage">
      ...
      <div>
        ...
        <small>
          <a onClick={() => setForgotEmail(true)}>Forgot Password?</a>
        </small>
      </div>
      ...
      {error === "try" ? (
        <p>
          ...
          <br />
          <br />
          Try Again In A Few Minutes <br /> or Contact Administrator
        </p>
      ) : (
        <></>
      )}
    ...
    <div id="forgotPassword">
      ...
      {!emailCheck ? (
        <>
          ...
          <br />
          <br />
          <small>A Code will be sent to your email </small>
          <br />
          <br />
          <button
            onClick={async () => {
              ...
              if (
                ...
                !validateEmail(forgotPasswordEmailRef.current.value)
              ) {
                setError("email");
              } else {
                ...
                if (response?.code === 200) {
                  setEmail(forgotPasswordEmailRef.current.value);
        ...
        <div id="updatepassword">
          ...
          <br />
          <input ref={codeRef} type="text" placeholder="Enter Code" />
          <br />
          <br />
          <small>Kindly Check Your Email For Access Code </small>
          <br />
          <br />
          <input ref={newpwdRef} type="password" placeholder="New Password" />
          <br />
          <br />
          <input
            ref={connewpwdRef}
