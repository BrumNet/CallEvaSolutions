...
export const Packages = () => {
  ...
  const subscribe = async (x) => {
    ...
    if (sessionData["profile"])
      update = await updateProfile(sessionData["profile"]?._id, args, {
        Package: x,
        PackageDate: d,
      });
    ...
    <div className="packages">
      <div>
        ...
        <div>
          {" "}
          <img
            src={sessionData["profile"]?.profilePicture || defaultpic}
            alt="Profile"
          />{" "}
        </div>
      </div>
        ...
        <div>
          <center>
            ...
            <p>Valid for 3 months</p>
            {
              ...
              : 
                <button onClick={() => subscribe("Basic")}> Buy </button>
            }
          </center>
        </div>
        ...
        <div>
          <center>
            ...
            <p>Valid for 6 months</p>
            {
              ...
              <button className="active">Active</button>
              : 
              <button onClick={() => subscribe("Gold")}> Buy </button>
            }
          </center>
        </div>
          ...
          <center>
            ...
            <p>Valid for 1 year</p>
            {
              ...
              ? 
                <button className="active">Active</button>
              : 
                <button onClick={() => subscribe("Premium")}> Buy </button>
            }
          </center>
        </div>
      </div>
      {
        ...
        ?
          <center>
            <small>You have a {mypackage} package running</small>
          </center>
        : 
          <center>
            <small>No Package running</small>
          </center>
      }
      <br />
    </div>
